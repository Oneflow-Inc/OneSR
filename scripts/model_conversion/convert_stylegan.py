...
from onesr.archs.stylegan2_arch import StyleGAN2Discriminator, StyleGAN2Generator
...
if __name__ == "__main__":
    """Convert official stylegan2 weights from stylegan2-pyflow."""

    # configuration
    ori_net = flow.load("experiments/pretrained_models/stylegan2-ffhq.pth")
    ...
    flow.save(dict(params=crt_net_params), save_path_d)
