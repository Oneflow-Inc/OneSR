...
def main(mode="folder"):
    ...
    if mode == "folder":
        ...
        opt[
            "dataroot_lq"
        ] = "datasets/vimeo90k/vimeo_septuplet_matlabLRx4/sequences"  # noqa E501
        opt[
            "meta_info_file"
        ] = "onesr/data/meta_info/meta_info_Vimeo90K_train_GT.txt"  # noqa E501
