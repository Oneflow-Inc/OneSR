...
from onesr.models.lr_scheduler import CosineAnnealingRestartLR
...
def main():
    optim_params = [
        {"params": [flow.zeros(3, 64, 3, 3)], "lr": 4e-4},
        {"params": [flow.zeros(3, 64, 3, 3)], "lr": 2e-4},
    ]
    ...
    scheduler = CosineAnnealingRestartLR(
        optimizer, period, restart_weights=restart_weights, eta_min=1e-7,
    )
