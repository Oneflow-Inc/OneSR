...
from flowvision import utils

from onesr.archs.stylegan2_arch import StyleGAN2Generator
from onesr.utils import set_random_seed
...
def generate(args, g_ema, device, mean_latent, randomize_noise):
    ...
    with flow.no_grad():
        ...
        for i in range(args.pics):
            sample_z = flow.randn(args.sample, args.latent, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="experiments/pretrained_models/StyleGAN/stylegan2_ffhq_config_f_1024_official-3ab41b38.pth",  # noqa: E251  # noqa: E501
    )
    ...
    checkpoint = flow.load(args.ckpt)["params_ema"]
