...
from onesr.archs.dfdnet_arch import DFDNet
from onesr.utils import imwrite, tensor2img
...
def get_part_location(landmarks):
    ...
    loc_left_eye = flow.from_numpy(loc_left_eye).unsqueeze(0)
    ...
    loc_right_eye = flow.from_numpy(loc_right_eye).unsqueeze(0)
    # nose
    ...
    loc_nose = flow.from_numpy(loc_nose).unsqueeze(0)
    # mouth
    ...
    loc_mouth = flow.from_numpy(loc_mouth).unsqueeze(0)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="experiments/pretrained_models/DFDNet/DFDNet_official-d1fa5650.pth",  # noqa: E251
    )
    parser.add_argument(
        "--dict_path",
        type=str,
        default="experiments/pretrained_models/DFDNet/DFDNet_dict_512-f79685f0.pth",  # noqa: E251
    )
    ...
    parser.add_argument(
        "--detection_path",
        type=str,
        default="experiments/pretrained_models/dlib/mmod_human_face_detector-4cb19393.dat",  # noqa: E251  # noqa: E501
    )
    parser.add_argument(
        "--landmark5_path",
        type=str,
        default="experiments/pretrained_models/dlib/shape_predictor_5_face_landmarks-c4b1e980.dat",  # noqa: E251  # noqa: E501
    )
    parser.add_argument(
        "--landmark68_path",
        type=str,
        default="experiments/pretrained_models/dlib/shape_predictor_68_face_landmarks-fbdc2cb8.dat",  # noqa: E251  # noqa: E501
    )
    ...
    checkpoint = flow.load(args.model_path, map_location=lambda storage, loc: storage)
