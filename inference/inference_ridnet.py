...
from onesr.archs.ridnet_arch import RIDNet
from onesr.utils.img_util import img2tensor, tensor2img
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="experiments/pretrained_models/RIDNet/RIDNet.pth",  # noqa: E251
    )
