...
from onesr.archs.inception import InceptionV3
...
def load_patched_inception_v3(device="cuda", resize_input=True, normalize_input=False):
    ...
    inception = InceptionV3(
        [3], resize_input=resize_input, normalize_input=normalize_input
    )
...
def extract_inception_features(
    data_generator, inception, len_generator=None, device="cuda"
):
