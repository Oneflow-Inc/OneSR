...
from onesr.data import build_dataloader, build_dataset
from onesr.data.data_sampler import EnlargedSampler
from onesr.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from onesr.models import build_model
from onesr.utils import (
    AvgTimer,
    MessageLogger,
    check_resume,
    get_env_info,
...
from onesr.utils.options import copy_opt_file, dict2str, parse_options
...
def load_resume_state(opt):
    ...
    if resume_state_path is None:
        ...
        device_id = flow.cuda.current_device()
        resume_state = flow.load(
...
def train_pipeline(root_path):
    ...
    flow.backends.cudnn.benchmark = True
    ...
    logger = get_root_logger(
        logger_name="onesr", log_level=logging.INFO, log_file=log_file
    )
