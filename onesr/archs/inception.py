...
from oneflow.utils.model_zoo import load_url
...
LOCAL_FID_WEIGHTS = (
    "experiments/pretrained_models/pt_inception-2015-12-05-6726825d.pth"  # noqa: E501
)
    ...
    def __init__(
        ...
        Args:
            ...
            use_fid_inception (bool): If true, uses the pretrained Inception
                ...
                and a slightly different structure from flowvision's
...
def fid_inception_v3():
    ...
    try:
        inception = models.inception_v3(
            num_classes=1008, aux_logits=False, pretrained=False, init_weights=False
        )
    except TypeError:
        # pytorch < 1.5 does not have init_weights for inception_v3
        inception = models.inception_v3(
