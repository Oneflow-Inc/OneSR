...
from onesr.data.prefetch_dataloader import PrefetchDataLoader
from onesr.utils import get_root_logger, scandir
from onesr.utils.dist_util import get_dist_info
...
_dataset_modules = [
    importlib.import_module(f"onesr.data.{file_name}")
...
def build_dataloader(
    ...
    Args:
        dataset (flow.utils.data.Dataset): Dataset.
        ...
        dist (bool): Whether in distributed training. Used only in the train
            phase. Default: False.
        sampler (flow.utils.data.sampler): Data sampler. Default: None.
    ...
    if prefetch_mode == "cpu":  # CPUPrefetcher
        ...
        return flow.utils.data.DataLoader(**dataloader_args)
