...
from onesr.data.data_util import duf_downsample, generate_frame_indices, read_img_seq
...
class VideoTestDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.cache_data:
            imgs_lq = self.imgs_lq[folder].index_select(0, flow.LongTensor(select_idx))
