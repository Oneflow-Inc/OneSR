...
from onesr.data.transforms import mod_crop
from onesr.utils import img2tensor, scandir
...
def duf_downsample(x, kernel_size=13, scale=4):
    ...
    gaussian_filter = (
        flow.from_numpy(gaussian_filter).type_as(x).unsqueeze(0).unsqueeze(0)
    )
